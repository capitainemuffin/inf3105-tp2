...
typename ArbreAVL<T>::Iterateur ArbreAVL<T>::rechercherEgalOuSuivant(const T& e) const
{
    ...
    Noeud* tmp = this->racine, *dernier = NULL;
...
//----------------------- Constructeurs Iterateur

template <class T> ArbreAVL<T>::Iterateur::Iterateur(const ArbreAVL& a)
 : arbre_associe(a), courant(NULL)
{
}

template <class T> ArbreAVL<T>::Iterateur::Iterateur(const ArbreAVL<T>::Iterateur& a)
